...
```hcl
module "signalfx-detectors-smart-agent-ntp" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/smart-agent_ntp?ref={revision}"
