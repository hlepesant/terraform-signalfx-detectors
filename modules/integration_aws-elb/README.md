...
```hcl
module "signalfx-detectors-integration-aws-elb" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-elb?ref={revision}"
