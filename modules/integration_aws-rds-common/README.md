# AWS-RDS-COMMON SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-aws-rds-common" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-rds-common?ref={revision}"
