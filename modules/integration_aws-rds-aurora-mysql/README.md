# AWS-RDS-AURORA-MYSQL SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-aws-rds-aurora-mysql" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-rds-aurora-mysql?ref={revision}"
