# AZURE-UPDATE-CENTER SignalFx detectors
...
```hcl
module "signalfx-detectors-fame-azure-update-center" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/fame_azure-update-center?ref={revision}"
...
* [FAME tool](https://github.com/claranet/terraform-azurerm-run/tree/master/modules/monitoring-function)
* [run Terraform module](https://registry.terraform.io/modules/claranet/run/azurerm/)
