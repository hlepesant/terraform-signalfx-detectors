# AZURE-AZURE-SEARCH SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-azure-azure-search" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_azure-azure-search?ref={revision}"
