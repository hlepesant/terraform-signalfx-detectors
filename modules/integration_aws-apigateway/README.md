# AWS-APIGATEWAY SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-aws-apigateway" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-apigateway?ref={revision}"
...
* `Count`
* `Latency`
* `${var.is_v2 ? "4xx" : "4XXError"}`
* `${var.is_v2 ? "5xx" : "5XXError"}`
...
* [Splunk Observability metadata](https://docs.splunk.com/observability/en/infrastructure/monitor/aws-infra-metadata.html#amazon-api-gateway-metadata)
