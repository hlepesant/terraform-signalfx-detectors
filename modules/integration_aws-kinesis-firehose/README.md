# AWS-KINESIS-FIREHOSE SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-aws-kinesis-firehose" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-kinesis-firehose?ref={revision}"
