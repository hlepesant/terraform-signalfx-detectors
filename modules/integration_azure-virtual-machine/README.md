# AZURE-VIRTUAL-MACHINE SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-azure-virtual-machine" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_azure-virtual-machine?ref={revision}"
