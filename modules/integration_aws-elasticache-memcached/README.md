# AWS-ELASTICACHE-MEMCACHED SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-aws-elasticache-memcached" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-elasticache-memcached?ref={revision}"
