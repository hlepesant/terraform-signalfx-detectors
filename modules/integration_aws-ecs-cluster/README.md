...
```hcl
module "signalfx-detectors-integration-aws-ecs-cluster" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-ecs-cluster?ref={revision}"
