...
```hcl
module "signalfx-detectors-integration-aws-beanstalk" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-beanstalk?ref={revision}"
