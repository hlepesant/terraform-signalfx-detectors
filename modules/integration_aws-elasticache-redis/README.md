# AWS-ELASTICACHE-REDIS SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-aws-elasticache-redis" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-elasticache-redis?ref={revision}"
