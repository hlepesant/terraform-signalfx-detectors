# SYSTEMD-SERVICES SignalFx detectors
...
```hcl
module "signalfx-detectors-smart-agent-systemd-services" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/smart-agent_systemd-services?ref={revision}"
