...
module "signalfx-detectors-smart-agent-cassandra" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/smart-agent_cassandra?ref={revision}"
...
* [Splunk Observability integration](https://docs.splunk.com/observability/en/gdi/monitors-databases/cassandra.html)
