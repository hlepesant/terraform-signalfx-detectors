# GCP-MEMORYSTORE-REDIS SignalFx detectors
...
module "signalfx-detectors-integration-gcp-memorystore-redis" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_gcp-memorystore-redis?ref={revision}"
