# GCP-PUBSUB-SUBSCRIPTION SignalFx detectors
...
```hcl
module "signalfx-detectors-integration-gcp-pubsub-subscription" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_gcp-pubsub-subscription?ref={revision}"
...
* [Splunk Observability metrics](https://docs.splunk.com/observability/en/gdi/get-data-in/connect/gcp/gcp.html#google-cloud-pub-sub-metrics)
