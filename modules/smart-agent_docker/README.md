...
module "signalfx-detectors-smart-agent-docker" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/smart-agent_docker?ref={revision}"
...
* [Splunk Observability integration](https://docs.splunk.com/observability/en/gdi/monitors-hosts/docker.html)
