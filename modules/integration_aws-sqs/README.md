...
```hcl
module "signalfx-detectors-integration-aws-sqs" {
  source = "github.com/hlepesant/terraform-signalfx-detectors.git//modules/integration_aws-sqs?ref={revision}"
